...
n95 = pd.read_excel(r"C:\Users\ejin3\OneDrive\Desktop\N95 Report.xlsx")
...
# print(mgh_units)
# mgh_units.to_excel(r"C:\Users\ejin3\OneDrive\Desktop\test2.xlsx")
#

mgh_units = n95.groupby(['Unit', 'Date', 'Mask'])

mgh_units.sum().to_excel(r"C:\Users\ejin3\OneDrive\Desktop\test2.xlsx")

# multi_index_df = n95.set_index(keys=['Date', 'Unit'])
# multi_index_df.to_excel(r"C:\Users\ejin3\OneDrive\Desktop\test.xlsx")
