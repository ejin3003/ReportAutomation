...
def main():
    ...
    raw_csdata_path = r"C:\Users\jt883\Desktop\Raw CS Data N95.xlsx"
    ...
    unit_report_df, unit_totals_df, total = unit_totals(raw_csdata_path)
    weekly_totals_df = add_weekly_total(weekly_totals_path, total)

    # Creates "Weekly N95 Report"
    create_n95_report(dest_weekly_n95_rep, n95_rep_df, unit_report_df, weekly_totals_df)
